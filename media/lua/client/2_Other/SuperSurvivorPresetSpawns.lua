...
--PresetSpawns[#PresetSpawns+1] = {GroupID = HillTopGroupID, PerkName = "Aiming",PerkLevel = 2, NoParty = true,  Name = "Hilltop Guard", X = 11711, Y = 7941, Z = 0 , Weapon = getWeapon("Base.Pistol"), Role = "Guard", isHostile = false, AIMode = ""}
--PresetSpawns[#PresetSpawns+1] = {GroupID = HillTopGroupID, PerkName = "Aiming",PerkLevel = 2, NoParty = true,  Name = "Hilltop Guard", X = 11711, Y = 7944, Z = 0 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Guard", isHostile = false, AIMode = ""}
--PresetSpawns[#PresetSpawns+1] = {GroupID = HillTopGroupID, PerkName = "Aiming",PerkLevel = 2, NoParty = true,  Name = "Hilltop Guard", X = 11708, Y = 7946, Z = 0 , Weapon = getWeapon("Base.VarmintRifle"), Role = "Guard", isHostile = false, AIMode = ""}
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Inmate", nil,  Name = "Prisoner", X = 7684, Y = 11925, Z = 1 , Weapon = "Base.LeadPipe", Orders = "Wander", isHostile = true};
...
--PresetSpawns[#PresetSpawns+1] = {Suit = "MarinesCamo", GroupID = BlockadeGroupID, InitGreeting = getText("ContextMenu_speech_BlockadeIntro"), PerkName = "Aiming",PerkLevel = 10, NoParty = true, isFemale=false,   Name = "General Carter", X = 12508, Y = 4487, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Guard", isHostile = false}; 
--PresetSpawns[#PresetSpawns+1] = {Suit = "MarinesCamo", GroupID = BlockadeGroupID, Greeting = "Move along now", PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12512, Y = 4487, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Guard", isHostile = false}; 
--PresetSpawns[#PresetSpawns+1] = {Suit = "MarinesCamo", GroupID = BlockadeGroupID, PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12517, Y = 4487, Z = 0 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Guard", isHostile = false}; 
--PresetSpawns[#PresetSpawns+1] = {Suit = "MarinesCamo", GroupID = BlockadeGroupID, Greeting = "You\'re not supposed to be up here, Move along!", PerkName = "Aiming", PerkLevel = 10, NoParty = true, isFemale=false,   Name = "Sniper", X = 12499, Y = 4497, Z = 3 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Standing Ground", isHostile = false}; 
--PresetSpawns[#PresetSpawns+1] = {Suit = "MarinesCamo", GroupID = BlockadeGroupID, Greeting = "What are you doing up here? Move along!", PerkName = "Aiming", PerkLevel = 10, NoParty = true, isFemale=false,   Name = "Sniper", X = 12527, Y = 4497, Z = 3 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Standing Ground", isHostile = false}; 

--PresetSpawns[#PresetSpawns+1] = {Suit = "MarinesCamo", GroupID = BlockadeGroupID, Greeting = "I\'m busy", PerkName = "Aiming", PerkLevel = 2, NoParty = true, isFemale=false,   Name = "Soldier", X = 12527, Y = 4485, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Patrol", isHostile = false, Patrolling=true, PX=-35,PY=-13}; 
...
--PresetSpawns[#PresetSpawns+1] = {Suit = "MarinesCamo", GroupID = BlockadeGroupID, Greeting = "This is the North East Blockade. No one is aloud past the rear Blockade. Lethal force will be used if necessary", PerkName = "Aiming",PerkLevel = 10, NoParty = true, isFemale=false,   Name = "Captain B.J. Blazkowicz", X = 12508, Y = (-2*300) + 4487, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Guard", isHostile = false}; 
--PresetSpawns[#PresetSpawns+1] = {Suit = "MarinesCamo", GroupID = BlockadeGroupID, Greeting = "Move along now", PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12512, Y = (-2*300) + 4487, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Guard", isHostile = false}; 
--PresetSpawns[#PresetSpawns+1] = {Suit = "MarinesCamo", GroupID = BlockadeGroupID, PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12517, Y = (-2*300) +4487, Z = 0 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Guard", isHostile = false}; 
--PresetSpawns[#PresetSpawns+1] = {Suit = "MarinesCamo", GroupID = BlockadeGroupID, Greeting = "You\'re not supposed to be up here, Move along!", PerkName = "Aiming", PerkLevel = 10, NoParty = true, isFemale=false,   Name = "Sniper", X = 12499, Y = (-2*300) + 4497, Z = 3 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Standing Ground", isHostile = false}; 
--PresetSpawns[#PresetSpawns+1] = {Suit = "MarinesCamo", GroupID = BlockadeGroupID, Greeting = "What are you doing up here? Move along!", PerkName = "Aiming", PerkLevel = 10, NoParty = true, isFemale=false,   Name = "Sniper", X = 12527, Y = (-2*300) + 4497, Z = 3 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Standing Ground", isHostile = false}; 

--PresetSpawns[#PresetSpawns+1] = {Suit = "MarinesCamo", GroupID = BlockadeGroupID, Greeting = "I\'m busy", PerkName = "Aiming", PerkLevel = 2, NoParty = true, isFemale=false,   Name = "Soldier", X = 12527, Y = (-2*300) + 4485, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Patrol", isHostile = false, Patrolling=true, PX=-35,PY=-13}; 
